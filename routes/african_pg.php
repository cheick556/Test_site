...
Route::any('/orange/pay', 'OrangeMoneyController@handlePayment')->name('orange.pay');
Route::any('/moov/pay', 'MoovMoneyController@initPayment')->name('moov.init');
Route::any('/coris/pay', 'CorisMoneyController@handlePayment')->name('coris.pay');
Route::any('/coris/init', 'CorisMoneyController@initPayment')->name('coris.init');
/*Route::any('/mobile_payment/payment_success/{order}', function(\App\Models\Order $order) {
    flash(translate('Payment completed'))->success();
    return view('frontend.order_confirmed', compact('order'));
})->name('mobile.payment_success');*/
