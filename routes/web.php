...
/*Route::any('/test', function (\Illuminate\Http\Request $request) {
    \App\Events\OrderStatusChangedEvent::dispatch(148, $request->status);
    return 'YO';
});*/
...
Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/order-to-confirm/{orderId}', 'CheckoutController@order_to_confirm')->name('order_to_confirm');
