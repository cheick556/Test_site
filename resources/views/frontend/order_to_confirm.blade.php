                    ...
                    <div class="card shadow-sm border-0 rounded">
                        <div class="card-body">
                            <div class="text-center py-4 mb-4">
                                ...
                                <h1 style="color:red" class="h3 mb-3 fw-600">{{ translate('You must now confirm the order by doing *555*6#')}}</h1>
                                <h2 class="h5">{{ translate('Order Code:')}} <span class="fw-700 text-primary"  style="color: #0abb75 !important;">{{ $order->code }}</span></h2>
